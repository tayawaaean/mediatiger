        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-slate-800 rounded-lg p-8">
            ...
            <p className="text-xl text-slate-300 mb-8">
              Make data-driven decisions with our advanced analytics and
              reporting tools.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="bg-slate-700 p-6 rounded-lg">
                ...
                <p className="text-slate-300">
                  Deep understanding of your audience demographics and behavior.
                </p>
              </div>
              <div className="bg-slate-700 p-6 rounded-lg">
                ...
                <p className="text-slate-300">
                  Track engagement, revenue, and growth across all channels.
                </p>
              </div>
              <div className="bg-slate-700 p-6 rounded-lg">
                ...
                <p className="text-slate-300">
                  Create tailored reports and dashboards for your specific
                  needs.
                </p>
              </div>
            </div>
