    ...
    content: [
      <div key="2.1">
        ...
        <ul className="list-disc pl-5 mt-1">
          <li>You represent that you have the legal authority to enter into agreements and that the information provided is accurate.</li>
        </ul>
      </div>,
      <div key="2.2" className="mt-2">
        <span className="font-semibold">2.2 Selection Process</span>
        <ul className="list-disc pl-5 mt-1">
          <li>Completing the registration form does not guarantee acceptance into the program.</li>
          <li>Applications will be reviewed based on eligibility, channel metrics, content quality, and compliance with platform policies.</li>
          <li>If selected, you will receive a separate agreement detailing your participation terms. Acceptance into the program is contingent upon signing this agreement.</li>
        </ul>
      </div>,
      <div key="2.3" className="mt-2">
        <span className="font-semibold">2.3 Reapplication</span>
        <ul className="list-disc pl-5 mt-1">
          <li>If your application is not selected, you may reapply immediately after changes have been made, subject to compliance with our policies and eligibility criteria.</li>
        </ul>
      </div>,
    ],
  },
  {
    ...
    content: [
      <div key="3.1">
        ...
        <ul className="list-disc pl-5 mt-1">
          <li>You have submitted the required information, including accurate and complete details as outlined in the registration process.</li>
          <li>You have reviewed, agreed to, and digitally signed the partnership contract provided by MediaTiger.</li>
        </ul>
        <p className="mt-1">
          By completing these steps, you acknowledge and accept the Terms and agree to participate in the program under its outlined policies.
        </p>
      </div>,
      <div key="3.2" className="mt-2">
        <span className="font-semibold">3.2 Validity</span>
        <ul className="list-disc pl-5 mt-1">
          <li>If you fail to provide accurate information or do not complete the signing process, the agreement will not be considered active, and program access may not be granted.</li>
        </ul>
      </div>,
    ],
  },
  {
    ...
    content: [
      <div key="4.1">
        ...
        <ul className="list-disc pl-5 mt-1">
          <li>Upon acceptance, you will gain access to MediaTiger's exclusive tools and licensed materials, such as music, templates, or other digital assets.</li>
          <li>Access to assets is subject to change and governed by relevant third-party terms, including YouTube's Terms of Service.</li>
        </ul>
      </div>,
      <div key="4.2" className="mt-2">
        <span className="font-semibold">4.2 Support and Resources</span>
        <ul className="list-disc pl-5 mt-1">
          <li>You will have access to personalized onboarding, training materials, and a dedicated support team to assist you in optimizing program benefits.</li>
          <li>Technical support is available for implementation and troubleshooting.</li>
        </ul>
      </div>,
      <div key="4.3" className="mt-2">
        <span className="font-semibold">4.3 Creator Responsibility</span>
        <ul className="list-disc pl-5 mt-1">
          <li>You are expected to actively engage with program resources and maintain communication with our team.</li>
          <li>Failure to comply with participation requirements may result in removal from the program.</li>
        </ul>
      </div>,
    ],
  },
  {
    ...
    content: [
      <div key="5.1">
        ...
        <ul className="list-disc pl-5 mt-1">
          <li>All rights, title, and interest in MediaTiger's music library remain with MediaTiger and its licensors.</li>
          <li>No ownership rights are transferred through program participation.</li>
          <li>You may not claim ownership or registration rights over any music provided through the program.</li>
          <li>You must respect all copyright notices and attributions as specified.</li>
        </ul>
      </div>,
    ],
  },
  {
    ...
    content: [
      <div key="6.1">
        ...
        <ul className="list-disc pl-5 mt-1">
          <li>Revenue-sharing terms will be outlined in the partnership agreement.</li>
          <li>Payments depend on platform monetization policies and are subject to deductions for applicable taxes and fees.</li>
        </ul>
      </div>,
      <div key="6.2" className="mt-2">
        <span className="font-semibold">6.2 Payment Processing</span>
        <ul className="list-disc pl-5 mt-1">
          <li>Payments are processed via [Payment Provider] and will be subject to their terms and conditions.</li>
          <li>It is your responsibility to provide accurate payment details. Delays or errors due to incorrect information will not be the liability of MediaTiger.</li>
        </ul>
      </div>,
    ],
  },
  {
    ...
    content: [
      <ul className="list-disc pl-5 mt-1" key="7">
        <li>Misrepresentation of information during registration is strictly prohibited.</li>
        <li>You may not manipulate metrics such as views, engagement, or other performance indicators.</li>
        <li>Using program materials in violation of platform policies or outside of agreed platforms will result in termination.</li>
      </ul>,
    ],
  },
  {
    ...
    content: [
      <div key="8.1">
        ...
        <p className="mt-1">All Channels must respect and obey the rules of YouTube, which can be found on the YouTube website.</p>
      </div>,
      <div key="8.2" className="mt-2">
        <span className="font-semibold">8.2 Revenue Withholding &amp; Policy Violations</span>
        <ul className="list-disc pl-5 mt-1">
          <li>If any recruited Channels are flagged, receive multiple Strikes, or otherwise generate revenues prone to claims from YouTube or third parties, the Company may withhold all payments to Recruiter until such issues are fully resolved.</li>
          <li>If YouTube or its affiliates issue payments despite these circumstances, the Company may retain such payments as compensation without forwarding revenue to Recruiter.</li>
        </ul>
      </div>,
    ],
  },
  {
    ...
    content: [
      <ul className="list-disc pl-5 mt-1" key="9">
        <li>MediaTiger shall not be liable for lost profits, revenues, or incidental damages.</li>
        <li>Our aggregate liability for any damages shall not exceed the greater of $100 USD or the amount paid in the past twelve months.</li>
      </ul>,
    ],
  },
  {
    ...
    content: [
      <ul className="list-disc pl-5 mt-1" key="10">
        <li>We may update these Terms at any time. Significant changes will be communicated via email.</li>
      </ul>,
    ],
  },
  {
    ...
    content: [
      <ul className="list-disc pl-5 mt-1" key="11">
        <li>By participating in the program, you consent to the collection and processing of personal data, such as contact details and analytics, for program purposes.</li>
      </ul>,
    ],
  },
  {
    ...
    content: [
      <p key="12p">
        The Creator agrees to indemnify, defend, and hold harmless the Licensor, its affiliates, assigns, sub-distributors, and licensees—including their directors, officers, shareholders, agents, and employees—against all third-party claims and resulting damages, liabilities, losses, costs, and expenses.
        This indemnification includes reasonable outside attorneys’ fees and court costs, arising from:
      </p>,
      <ul className="list-disc pl-5 mt-1" key="12ul">
        <li>Any breach or alleged breach by the Creator of warranties, representations, or agreements made herein.</li>
        <li>Any act, error, or omission committed by the Creator or any person/entity acting on the Creator’s behalf.</li>
      </ul>,
    ],
  },
  {
    ...
    content: [
      <div key="13.1">
        ...
        <ul className="list-disc pl-5 mt-1">
          <li>The User is responsible for filing accurate tax returns and social security contributions in connection with this Agreement and for ensuring prompt payment thereof.</li>
          <li>Compliance with applicable tax laws is the User’s sole responsibility.</li>
        </ul>
      </div>,
    ],
  },
  {
    ...
    content: [
      <ul className="list-disc pl-5 mt-1" key="14">
        <li>Neither party shall be liable for delays or failures due to circumstances beyond reasonable control, including changes in platform policies or technical issues.</li>
      </ul>,
    ],
  },
  {
    ...
    content: [
      <ul className="list-disc pl-5 mt-1" key="15">
        <li>These Terms are governed by the laws of the United States. Any disputes will be subject to the exclusive jurisdiction of U.S. courts.</li>
      </ul>,
    ],
  },
  {
    ...
    content: [
      <ul className="list-disc pl-5 mt-1" key="16">
        <li>For questions about these Terms, please contact <a href="mailto:support@mediatiger.co" className="underline text-blue-400">support@mediatiger.co</a>.</li>
      </ul>,
    ],
  },
];
