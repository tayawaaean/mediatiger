  ...
  const SmoothImage = ({ src, alt }: { src: string; alt: string }) => {
    ...
    return (
      <img
        ...
        className={`rounded-lg border border-border max-w-full transition-opacity duration-500 ease-in-out ${
    ...
    <div className="space-y-8">
      <section>
        ...
        <p className="text-slate-400">
          Welcome to the upload guide. This guide will help you understand how
      ...
      <section>
        <h3 className="text-xl font-semibold mb-3">
          Mobile Upload Time Limits Removal
        </h3>
