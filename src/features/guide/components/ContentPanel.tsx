          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-slate-400 mb-6">
                The dashboard is your central hub for managing your content and
                tracking performance. Here's what you'll find in each section:
              </p>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-slate-400">
                    View your overall metrics, set monthly goals, check
                    announcements, manage notifications, adjust settings, and
                    access your personal live support chat.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-slate-400">
                    Access detailed analytics for your channels, including
                    views, RPM, and earning amounts.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-slate-400">
                    Manage your current channels and view affiliate channels
                    (those who signed up with your referral code).
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-slate-400">
                    Browse the comprehensive list of background music and
                    request custom background music.
                  </p>
                </div>
