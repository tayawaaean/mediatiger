...
const BenefitItem: React.FC<BenefitItemProps> = ({ icon, text, index }) => (
  <div 
    className="group flex items-start space-x-4 p-6 rounded-2xl bg-slate-800/30 backdrop-blur-sm border border-slate-700/50 hover:border-indigo-500/50 transition-all duration-500 hover:bg-slate-700/40 hover:shadow-2xl hover:shadow-indigo-500/10 transform hover:scale-[1.02]"
...
const WhyCreatorsLove: React.FC = () => {
  ...
  const { containerRef: benefitsRef, getItemClasses } = useStaggeredAnimation(6, 150);
  ...
  return (
    <div ref={sectionRef} className={`relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-24 overflow-hidden ${sectionClasses}`}>
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-purple-500/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        ...
        <div className="absolute top-20 left-1/4 w-48 h-48 bg-gradient-to-r from-indigo-400/10 to-purple-400/10 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '0.5s' }}></div>
        <div className="absolute bottom-20 right-1/4 w-56 h-56 bg-gradient-to-r from-purple-400/10 to-blue-400/10 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '1.5s' }}></div>
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-indigo-400/5 to-transparent animate-pulse" style={{ animationDuration: '3s' }}></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div ref={headerRef} className={`text-center mb-16 ${headerClasses}`}>
          <h2 className="relative inline-block mb-6">
            <span className="text-4xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 via-purple-200 to-indigo-300 tracking-tight leading-tight drop-shadow-2xl">
              Why Creators Love MediaTiger
            </span>
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-purple-400/15 via-indigo-300/15 to-purple-400/15 blur-xl -z-10 animate-pulse" style={{ animationDelay: '1s' }}></div>
            
            {/* Sparkle effects */}
            <div className="absolute -top-3 -left-3 w-2 h-2 bg-indigo-300 rounded-full animate-ping opacity-60"></div>
            <div className="absolute -top-1 -right-4 w-1.5 h-1.5 bg-purple-300 rounded-full animate-ping opacity-50" style={{ animationDelay: '0.5s' }}></div>
            <div className="absolute -bottom-4 left-6 w-1.5 h-1.5 bg-indigo-400 rounded-full animate-ping opacity-40" style={{ animationDelay: '1s' }}></div>
            <div className="absolute -bottom-3 -right-3 w-2 h-2 bg-purple-400 rounded-full animate-ping opacity-55" style={{ animationDelay: '1.5s' }}></div>
          </h2>
        </div>

        {/* Benefits grid */}
        <div ref={benefitsRef} className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
