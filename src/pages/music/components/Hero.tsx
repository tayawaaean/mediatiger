...
const Hero: React.FC<HeroProps & { loadingState: LoadingState }> = ({ isPageLoaded, loadingState }) => {
  ...
  const videoUrl = 'https://vaeuvecjtnvismnobvyy.supabase.co/storage/v1/object/sign/videos/freecompress-mediatiger%20music%20revenue%20new..mp4?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV9iMjIwY2U2Mi0zNDQwLTQyNjAtOTZjNy04MGQ2YWYzZTY2NDgiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJ2aWRlb3MvZnJlZWNvbXByZXNzLW1lZGlhdGlnZXIgbXVzaWMgcmV2ZW51ZSBuZXcuLm1wNCIsImlhdCI6MTc0OTcxNDY4NSwiZXhwIjoxNzgxMjUwNjg1fQ.cXohIdYwR38Mu_ZIy5h5UsVa0hBvD85fRqxEdU-3T8U';
    ...
    <>
      ...
      <div
        className={`relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20 min-h-screen flex flex-col justify-center text-center z-10 transition-all duration-1000 ease-out ${
          loadingState.isHeroLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
        }`}
      >
        <div className="relative">
          ...
          >
            <span className="text-white">
              Turn Your <span className="inline-block bg-purple-500 text-white px-4 py-2 rounded-lg shadow-2xl ring-1 ring-purple-400/30 transform -rotate-1 font-bold hover:shadow-purple-500/50 transition-all duration-300 hover:scale-105">YouTube</span> Shorts
            </span>
            <br />
            <span className="text-white">
          ...
          >
            <p className="text-lg md:text-xl text-white font-medium">
              Over <span className="font-bold text-indigo-400">300 creators</span> are earning extra revenue every day.{" "}
              <span className="font-bold text-green-400">Absolutely FREE</span> to start and earn immediately.
            </p>
          </div>
          ...
          >
            <div className="relative bg-slate-800/95 backdrop-blur-sm p-6 rounded-2xl shadow-2xl ring-1 ring-white/10 hover:shadow-3xl transition-all duration-300 transform hover:scale-[1.02]">
              ...
              <p className="text-base md:text-lg font-bold text-white mb-8 leading-tight">
                ...
                <span className="text-green-400">$5K-$20K+/MONTH</span>{" "}
                from Shorts.
              </p>
          ...
          >
            <div className="flex flex-col items-center space-y-2 group cursor-pointer" onClick={() => {
