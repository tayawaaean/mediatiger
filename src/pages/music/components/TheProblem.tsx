...
const TheProblem: React.FC = () => {
  ...
  const { elementRef: subtitleRef, animationClasses: subtitleClasses } =
    useScrollAnimation({
  ...
  const { containerRef: statsRef, getItemClasses } = useStaggeredAnimation(
    3,
    200
  );
  ...
  return (
    <div className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-32 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute -bottom-32 -right-32 w-96 h-96 bg-orange-500/10 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-yellow-500/5 rounded-full blur-2xl animate-pulse"
        ...
        <div className="text-center">
          ...
          <div ref={headerRef} className={headerClasses}>
            <h2 className="relative inline-block mb-8">
              <span className="text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-red-400 via-orange-400 to-yellow-400 tracking-tight leading-tight">
                The Problem
              </span>
          ...
          <div
            ref={subtitleRef}
            className={`max-w-5xl mx-auto mb-12 ${subtitleClasses}`}
          >
            <p className="text-2xl md:text-2xl text-slate-200 leading-relaxed font-light mb-6">
              Most YouTube creators are{" "}
              <span className="relative inline-block">
                <span className="relative z-10 font-bold text-red-300">
              ...
              <span className="relative inline-block">
                <span className="relative z-10 font-bold text-yellow-300">
                  monetizable music
                </span>
          ...
          >
            ...
            <div className={`relative group ${getItemClasses(0)}`}>
              <div className="relative bg-slate-800/50 backdrop-blur-sm border border-red-500/30 rounded-2xl p-8 shadow-2xl hover:shadow-red-500/20 transition-all duration-500 transform hover:scale-105">
                ...
                <div className="relative z-10">
                  <TrendingDown className="w-8 h-8 text-red-400 mx-auto mb-4 group-hover:scale-110 transition-transform duration-300" />
            ...
            <div className={`relative group ${getItemClasses(1)}`}>
              <div className="relative bg-slate-800/50 backdrop-blur-sm border border-orange-500/30 rounded-2xl p-8 shadow-2xl hover:shadow-orange-500/20 transition-all duration-500 transform hover:scale-105">
                ...
                <div className="relative z-10">
                  <DollarSign className="w-8 h-8 text-orange-400 mx-auto mb-4 group-hover:scale-110 transition-transform duration-300" />
                  <div className="text-3xl font-black text-orange-300 mb-2">
                    95%
                  </div>
                  <div className="text-slate-300 font-medium">
                    Creators Missing Out
                  </div>
                </div>
          ...
          <div ref={ctaRef} className={`mt-16 ${ctaClasses}`}>
            <div className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-slate-800/80 to-slate-700/80 backdrop-blur-sm border border-slate-600/50 rounded-full shadow-2xl">
              <span className="text-slate-300 font-medium text-lg mr-3">
