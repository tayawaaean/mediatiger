...
const SignUp: React.FC = () => {
  ...
  const { containerRef: stepsRef, getItemClasses } = useStaggeredAnimation(3, 300);

  return (
    <div ref={sectionRef} className={`relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-20 overflow-hidden -mt-20 ${sectionClasses}`}>
      ...
      <div ref={stepsRef} className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div className={`flex items-center justify-center gap-6 text-left ${getItemClasses(0)}`}>
          {/* Mascot Image */}
          ...
          <div className="flex-shrink-0">
            ...
            <h3 className="relative inline-block mb-6">
              <span className="text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-yellow-100 to-amber-200 tracking-tight leading-tight">
                Sign Up
              </span>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 mt-20">
        <div className={`flex items-center justify-center gap-6 text-left ${getItemClasses(1)}`}>
          {/* Mascot Image */}
          <div className="flex-shrink-0">
            <img 
          ...
          <div className="flex-shrink-0">
            ...
            <div className="max-w-sm">
              <p className="text-lg md:text-xl text-slate-300 leading-relaxed font-light">
                Select from our library of revenue-generating tracks and add it to your Shorts video during upload.
              </p>
            </div>
          </div>
      ...
      {/* Earn More Section */}
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 mt-20">
        <div className={`flex items-center justify-center gap-6 text-left ${getItemClasses(2)}`}>
          {/* Mascot Image */}
          <div className="flex-shrink-0">
            <img 
