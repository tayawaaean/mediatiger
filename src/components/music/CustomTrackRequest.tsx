  ...
  return (
    <div className="bg-slate-800/50 rounded-2xl border border-slate-700/50 p-8 animate-section">
      ...
      <p className="text-slate-400 mb-8">
        Request a custom track for your content. Please provide at least one
        reference track and/or a detailed description of the track you want. You
        can also include example videos where you plan to use the track.
      </p>
      ...
      <div className="space-y-8">
        ...
        <div>
          <label className="block text-white mb-4">
            Track Description (If No References)
          </label>
          <textarea
